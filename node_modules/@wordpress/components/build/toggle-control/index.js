...
function UnforwardedToggleControl({
  ...
  const classes = cx("components-toggle-control", className, !__nextHasNoMarginBottom && /* @__PURE__ */ (0, import_react.css)({
    marginBottom: (0, import_space.space)(3)
  ...
  if (!__nextHasNoMarginBottom) {
    (0, import_deprecated.default)("Bottom margin styles for wp.components.ToggleControl", {
      since: "6.7",
      version: "7.0",
...
const ToggleControl = (0, import_element.forwardRef)(UnforwardedToggleControl);
