...
const SelectWrapper = /* @__PURE__ */ (0, import_base.default)(import_flex.FlexBlock, process.env.NODE_ENV === "production" ? {
  target: "e10bzpgi1"
} : {
  target: "e10bzpgi1",
  label: "SelectWrapper"
...
const AccessoryWrapper = /* @__PURE__ */ (0, import_base.default)(import_flex.FlexBlock, process.env.NODE_ENV === "production" ? {
  target: "e10bzpgi0"
} : {
  target: "e10bzpgi0",
