...
function UnconnectedNavigatorBackButton(props, forwardedRef) {
  const navigatorBackButtonProps = (0, import_hook.useNavigatorBackButton)(props);
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_view.View, {
    ref: forwardedRef,
    ...navigatorBackButtonProps
  });
}
const NavigatorBackButton = (0, import_context.contextConnect)(UnconnectedNavigatorBackButton, "Navigator.BackButton");
