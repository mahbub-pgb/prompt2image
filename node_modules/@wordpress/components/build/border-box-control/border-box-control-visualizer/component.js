...
const BorderBoxControlVisualizer = (props, forwardedRef) => {
  const {
    value,
    ...otherProps
  } = (0, import_hook.useBorderBoxControlVisualizer)(props);
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_view.View, {
    ...otherProps,
    ref: forwardedRef
  });
};
const ConnectedBorderBoxControlVisualizer = (0, import_context.contextConnect)(BorderBoxControlVisualizer, "BorderBoxControlVisualizer");
