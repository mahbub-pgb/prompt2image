...
__export(styles_exports, {
  VisualLabelWrapper: () => VisualLabelWrapper,
  block: () => block,
  toggleGroupControl: () => toggleGroupControl,
  toggleGroupControlSize: () => toggleGroupControlSize
});
...
const VisualLabelWrapper = /* @__PURE__ */ (0, import_base.default)("div", process.env.NODE_ENV === "production" ? {
  target: "eakva830"
} : {
  target: "eakva830",
