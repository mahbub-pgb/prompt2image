...
function UnconnectedCardBody(props, forwardedRef) {
  const {
    isScrollable,
    ...otherProps
  } = (0, import_hook.useCardBody)(props);
  if (isScrollable) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_scrollable.Scrollable, {
      ...otherProps,
      ref: forwardedRef
    });
  }
...
const CardBody = (0, import_context.contextConnect)(UnconnectedCardBody, "CardBody");
