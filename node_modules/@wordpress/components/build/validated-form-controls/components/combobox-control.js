...
__export(combobox_control_exports, {
  ValidatedComboboxControl: () => ValidatedComboboxControl
});
...
const UnforwardedValidatedComboboxControl = ({
  ...
  return (
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_control_with_error.ControlWithError, {
      required,
      markWhenOptional,
      ref: mergedRefs,
      onValidate: () => {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_combobox_control.default, {
...
const ValidatedComboboxControl = (0, import_element.forwardRef)(UnforwardedValidatedComboboxControl);
