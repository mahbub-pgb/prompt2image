...
var config_values_default = Object.assign({}, CONTROL_PROPS, {
  ...
  gridBase: "4px",
  cardPaddingXSmall: `${(0, import_space.space)(2)}`,
  cardPaddingSmall: `${(0, import_space.space)(4)}`,
  cardPaddingMedium: `${(0, import_space.space)(4)} ${(0, import_space.space)(6)}`,
  cardPaddingLarge: `${(0, import_space.space)(6)} ${(0, import_space.space)(8)}`,
