...
const Input = /* @__PURE__ */ (0, import_base.default)(import_input_control.default, process.env.NODE_ENV === "production" ? {
  target: "ep09it41"
} : {
  target: "ep09it41",
  label: "Input"
...
const SpinButton = /* @__PURE__ */ (0, import_base.default)(import_button.default, process.env.NODE_ENV === "production" ? {
  target: "ep09it40"
} : {
  target: "ep09it40",
  label: "SpinButton"
...
const smallSpinButtons = /* @__PURE__ */ (0, import_react.css)("width:", (0, import_space.space)(5), ";min-width:", (0, import_space.space)(5), ";height:", (0, import_space.space)(5), ";" + (process.env.NODE_ENV === "production" ? "" : ";label:smallSpinButtons;"), process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
const styles = {
  smallSpinButtons
};
