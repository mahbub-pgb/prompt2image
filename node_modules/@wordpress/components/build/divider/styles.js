...
const renderMargin = ({
  ...
  marginStart,
  marginEnd
}) => /* @__PURE__ */ (0, import_react.css)((0, import_utils.rtl)({
  [MARGIN_DIRECTIONS[orientation].start]: (0, import_space.space)(marginStart !== null && marginStart !== void 0 ? marginStart : margin),
  [MARGIN_DIRECTIONS[orientation].end]: (0, import_space.space)(marginEnd !== null && marginEnd !== void 0 ? marginEnd : margin)
...
const DividerView = /* @__PURE__ */ (0, import_base.default)("hr", process.env.NODE_ENV === "production" ? {
  target: "e19on6iw0"
} : {
  target: "e19on6iw0",
  label: "DividerView"
