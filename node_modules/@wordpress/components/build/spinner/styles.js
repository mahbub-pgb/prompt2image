...
const spinAnimation = import_react.keyframes`
	from {
 ...
 `;
const StyledSpinner = /* @__PURE__ */ (0, import_base.default)("svg", process.env.NODE_ENV === "production" ? {
  target: "ea4tfvq2"
} : {
  target: "ea4tfvq2",
  label: "StyledSpinner"
...
const SpinnerTrack = /* @__PURE__ */ (0, import_base.default)("circle", process.env.NODE_ENV === "production" ? {
  target: "ea4tfvq1"
} : {
  target: "ea4tfvq1",
  label: "SpinnerTrack"
...
const SpinnerIndicator = /* @__PURE__ */ (0, import_base.default)("path", process.env.NODE_ENV === "production" ? {
  target: "ea4tfvq0"
} : {
  target: "ea4tfvq0",
