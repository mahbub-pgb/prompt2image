...
const StyledInputBase = /* @__PURE__ */ _styled(InputBase, process.env.NODE_ENV === "production" ? {
  target: "e1mv6sxx3"
} : {
  target: "e1mv6sxx3",
...
const Select = /* @__PURE__ */ _styled("select", process.env.NODE_ENV === "production" ? {
  target: "e1mv6sxx2"
} : {
  target: "e1mv6sxx2",
  label: "Select"
...
const DownArrowWrapper = /* @__PURE__ */ _styled("div", process.env.NODE_ENV === "production" ? {
  target: "e1mv6sxx1"
} : {
  target: "e1mv6sxx1",
...
const InputControlSuffixWrapperWithClickThrough = /* @__PURE__ */ _styled(InputControlSuffixWrapper, process.env.NODE_ENV === "production" ? {
  target: "e1mv6sxx0"
} : {
  target: "e1mv6sxx0",
