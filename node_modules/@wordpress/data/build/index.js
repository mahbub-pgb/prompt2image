...
const combineReducers = import_redux_store.combineReducers;
const resolveSelect = import_default_registry.default.resolveSelect;
const suspendSelect = import_default_registry.default.suspendSelect;
const subscribe = import_default_registry.default.subscribe;
const registerGenericStore = import_default_registry.default.registerGenericStore;
const registerStore = import_default_registry.default.registerStore;
const use = import_default_registry.default.use;
const register = import_default_registry.default.register;
