...
var _NKOBBETCcjs = require('./NKOBBETC.cjs');


var _LSIWYIVTcjs = require('./LSIWYIVT.cjs');
...
var useHovercard = _WULEED4Qcjs.createHook.call(void 0, 
  function useHovercard2(_a) {
    ...
    const hideOnHoverOutsideProp = _OZM4QA2Vcjs.useBooleanEvent.call(void 0, hideOnHoverOutside);
    const mayDisablePointerEvents = !!disablePointerEventsOnApproach;
    const disablePointerEventsProp = _OZM4QA2Vcjs.useBooleanEvent.call(void 0, 
      disablePointerEventsOnApproach
    );
    ...
    const openRef = _OZM4QA2Vcjs.useLiveRef.call(void 0, open);
    _react.useEffect.call(void 0, () => {
      if (!domReady) return;
      return () => {
        if (!openRef.current) {
    ...
    props = _OZM4QA2Vcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _6F6SPO63cjs.HovercardScopedContextProvider, { value: store, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, NestedHovercardContext.Provider, { value: registerNestedHovercard, children: element }) }),
    ...
    props = _NKOBBETCcjs.usePopover.call(void 0, _7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {
      store,
      modal,
      portal,
      autoFocusOnShow
...
var Hovercard = _LSIWYIVTcjs.createDialogComponent.call(void 0, 
  _WULEED4Qcjs.forwardRef.call(void 0, function Hovercard2(props) {
    const htmlProps = useHovercard(props);
    return _WULEED4Qcjs.createElement.call(void 0, TagName, htmlProps);
  }),
  _6F6SPO63cjs.useHovercardProviderContext
);
